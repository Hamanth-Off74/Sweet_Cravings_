...
| Deployment | Railway, Render, or another Node-compatible host; Vercel can host the client separately |
...
1. Deploy the backend to Railway, Render, or another Node host.
...
The repository also includes [DEPLOYMENT_GUIDE.md](DEPLOYMENT_GUIDE.md), [RAILWAY_DEPLOYMENT.md](RAILWAY_DEPLOYMENT.md), and [RAILWAY_DEPLOYMENT_GUIDE.md](RAILWAY_DEPLOYMENT_GUIDE.md) with provider-specific notes.
