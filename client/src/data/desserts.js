...
export const getFeaturedDesserts = () => {
    return [
        desserts.find(d => d.name === 'Chocolate Cake'),
        desserts.find(d => d.name === 'Cheesecake'),
        desserts.find(d => d.name === 'Fudgy Chocolate Brownie'),
        desserts.find(d => d.name === 'Fruit Tart'),
        desserts.find(d => d.name === 'Chocolate Fudge Brownie Ice Cream')
    ].filter(Boolean);
};

export const getLimitedDesserts = (limit = 5) => {
