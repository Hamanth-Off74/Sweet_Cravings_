...
// Static dessert data with 10+ items per major category
const desserts = [
...
// Routes
router.get('/', (req, res) => {
    res.render('home', { desserts: desserts.slice(0, 3) }); // Show first 3 for featured
});
...
router.post('/api/order', (req, res) => {
    ...
    const orderId = 'SC' + Math.random().toString(36).substr(2, 9).toUpperCase();
