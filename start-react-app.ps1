...
if (!$mongoProcess) {
    Write-Host "WARNING: MongoDB is not running. Please start MongoDB first." -ForegroundColor Red
...
Write-Host "Starting React Frontend (Port 3005)..." -ForegroundColor Yellow
...
Write-Host "   Backend:  ${import.meta.env.VITE_API_BASE_URL}" -ForegroundColor Gray
Write-Host "   Frontend: http://localhost:3005" -ForegroundColor Gray
Write-Host ""
